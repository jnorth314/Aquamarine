# <img src="res/icon.ico" width=32 height=32> Aquamarine

An application to view and monitor Bluetooth devices through the use of SiliconLabs's [pybgapi](https://github.com/SiliconLabs/pybgapi).

<img src="res/sample_gui.png">
